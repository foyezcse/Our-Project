...
<html>
  ...
  "navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <h1 id="section-tittle">Evercare <span>Hospital Dhaka</span></h1>
            <div class="row text-left">
              <div class="col-md-6">
                      <img src="images/ever.jpg" alt="Responsive image" class="img-fluid">
              </div>
              ...
              <div class="col-md-5">
                ...
                <a href="https://www.evercarebd.com/" class="btn btn-primary btn-lg active justify-space-between" role="button" aria-pressed="true"><i class="fa fa-globe mx-2" aria-hidden="true"></i>Website</a>
                  <a href="https://www.google.com/search?tbs=lf:1,lf_ui:2&tbm=lcl&sxsrf=ALeKk01bLMnV23BttIdNsMJ9UNf4Pdw9ag:1613147309273&q=autism+hospital+in+bangladesh&rflfq=1&num=10&sa=X&ved=2ahUKEwjHm9uC4uTuAhV07HMBHUIjAsUQjGp6BAgEEFE&biw=1366&bih=657#" class="btn btn-primary btn-lg active" role="button" aria-pressed="true"> <i class="fa fa-compass mx-1" aria-hidden="true"></i>Direction</a>
              </div>
